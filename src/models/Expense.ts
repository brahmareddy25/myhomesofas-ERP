...
export interface IExpense extends Document {
  ...
  category: 'Rent' | 'Electricity' | 'Water' | 'Maintenance' | 'Logistics' | 'Marketing' | 'Office Supplies' | 'Other' | 'Salary' | 'Material';
  description: string;
  amount: number;
...
const ExpenseSchema: Schema = new Schema(
  {
    ...
    category: {
      type: String,
      enum: ['Rent', 'Electricity', 'Water', 'Maintenance', 'Logistics', 'Marketing', 'Office Supplies', 'Other', 'Salary', 'Material'],
      required: true,
    },
